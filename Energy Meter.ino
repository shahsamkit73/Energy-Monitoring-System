...
void loop()
{
  result1 = node.readHoldingRegisters(0x0100,2); //This loop is to get the output of 4 bytes (Float datatype) 
  if (result1 == node.ku8MBSuccess)   //[readHoldingRegisters(Address of the register, Number of registers want to be read from this address)]
  {
